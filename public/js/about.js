...
/***/ function(module, exports, __webpack_require__) {
	...
	var total = React.createClass({
		...
		render: function render() {
			...
			// rce('div', {}, 'left')
			rce('div', { 'className': 'bio-image' }, rce('img', { 'className': 'myImage', 'src': '../img/myImg.png', 'onClick': this.handleClickMyImg })), rce('div', { 'className': 'title' }, 'Things I\'m good at'), rce('div', { 'className': 'content-area' }, rce('div', { 'className': 'skill html' }, 'JavaScript'), rce('div', { 'className': 'skill css' }, 'HTML/CSS'), rce('div', { 'className': 'skill javascript' }, 'React'), rce('div', { 'className': 'skill koa' }, 'Node.js'), rce('div', { 'className': 'skill nodejs' }, 'Koa')), rce('div', { 'className': 'title' }, 'Things I love'), rce('div', { 'className': 'content-area' }, rce('div', { 'className': 'skill html' }, 'JavsScript'), rce('div', { 'className': 'skill css' }, 'Node.js'), rce('div', { 'className': 'skill javascript' }, 'Popkart'), rce('div', { 'className': 'skill koa' }, 'Travel'), rce('div', { 'className': 'skill nodejs' }, 'zero'))), rce('div', { 'className': 'mainContainer-right' }, rce('h2', { 'className': 'to-blog', 'onClick': this.toBlog, 'onTouchStart': this.toBlog }, 'To my Blog'), rce('br', null), rce('h2', null, 'Who are you?'), rce('p', null, 'who are you'), rce('h2', null, 'Where are you ?'), rce('p', null, 'where are you'), rce('h2', null, 'What are you up to at the moment?'), rce('p', null, 'what are you up to at the moment?')))));
		}
	});
