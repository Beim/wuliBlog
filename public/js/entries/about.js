					...
					rce('div', {'className': 'mainContainer-content'},
						rce('div', {'className': 'mainContainer-left'},
							...
							rce('div', {'className': 'content-area' },
								rce('div', {'className': 'skill html'}, 'JavaScript'),
								rce('div', {'className': 'skill css'}, 'HTML/CSS'),
								rce('div', {'className': 'skill javascript'}, 'React'),
								rce('div', {'className': 'skill koa'}, 'Node.js'),
								rce('div', {'className': 'skill nodejs'}, 'Koa')
							),
							rce('div', {'className': 'title'}, `Things I love`),
							rce('div', {'className': 'content-area' },
								rce('div', {'className': 'skill html'}, 'JavsScript'),
								rce('div', {'className': 'skill css'}, 'Node.js'),
								rce('div', {'className': 'skill javascript'}, 'Popkart'),
								rce('div', {'className': 'skill koa'}, 'Travel'),
